...
train_data_dir = 'e:/test_gnt' #'E:/HWDB1.0-1.2/Gnt1.2Train'
# test_data_dir = 'E:/HWDB1.0-1.2/Gnt1.2Test'
...
for image, tagcode in read_from_gnt_dir(gnt_dir=train_data_dir):
    ...
    dir_name = './data/train1.2/' + '%0.5d' % char_dict[tagcode_unicode]
...
#     tagcode_unicode = struct.pack('>H', tagcode).decode('gbk')
#     im = Image.fromarray(image)
#     dir_name = '../data/test1.2/' + '%0.5d' % char_dict[tagcode_unicode]
#     if not os.path.exists(dir_name):
#         os.mkdir(dir_name)
